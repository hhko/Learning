...
namespace Ch03_Step1_ApplicaionService.UnitTests
{
    public class MoneySpecs
    {
        ...
        public void Cannot_subtract_more_than_exists()
        {
            ...
            Action action = () =>
            {
                // OneCentCount         0 - 1 = -1 생성자 예외 발생
                // TenCentCount         1 - 0 = 0
                // QuarterCount         0 - 0 = 0
                // OneDollarCount       0 - 0 = 0
                // FiveDollarCount      0 - 0 = 0
                // TwentyDollarCount    0 - 0 = 0
