using Ch02_Step4_Akkatecture.Logic;
using FluentAssertions;
using System;
using Xunit;
using static Ch02_Step4_Akkatecture.Logic.Money;

namespace Ch02_Step4_Akkatecture.UnitTests
{
    public class MoneySpecs
    {
        ...
        public void Two_money_instances_equal_if_contain_the_same_money_amount()
        {
            ...
            // Step 2.
            //money1.ValueEquals(money2).Should().BeTrue();
        }
        ...
        public void Two_money_instances_do_not_equal_if_contain_different_money_amounts()
        {
            ...
            // Step 2.
            //dollar.ValueEquals(hundredCents).Should().BeFalse();
        }
